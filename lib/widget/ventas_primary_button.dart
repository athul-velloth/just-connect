...
class VentasPrimaryButton extends StatefulWidget {
  ...
  @override
  State<VentasPrimaryButton> createState() => _VentasPrimaryButtonState();
}

class _VentasPrimaryButtonState extends State<VentasPrimaryButton> {
